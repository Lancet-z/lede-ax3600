...
#3.固件版本号添加个人标识和日期
sed -i "s/DISTRIB_DESCRIPTION='OpenWrt '/DISTRIB_DESCRIPTION='迷宫旅人.ver $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt '/g" package/lean/default-settings/files/zzz-default-settings
